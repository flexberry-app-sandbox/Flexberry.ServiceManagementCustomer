...
moduleForAcceptance('[AGAT] Acceptance | i i s service management customer service provider l');

test('testing i-i-s-service-management-customer-service-provider-l', function(assert) {
