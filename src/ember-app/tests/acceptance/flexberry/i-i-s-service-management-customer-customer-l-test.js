...
moduleForAcceptance('[AGAT] Acceptance | i i s service management customer customer l');

test('testing i-i-s-service-management-customer-customer-l', function(assert) {
