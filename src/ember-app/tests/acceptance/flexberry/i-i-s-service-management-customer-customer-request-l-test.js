...
moduleForAcceptance('[AGAT] Acceptance | i i s service management customer customer request l');

test('testing i-i-s-service-management-customer-customer-request-l', function(assert) {
