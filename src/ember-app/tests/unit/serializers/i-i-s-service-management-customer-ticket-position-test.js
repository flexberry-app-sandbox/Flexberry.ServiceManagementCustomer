...
moduleForModel('i-i-s-service-management-customer-ticket-position', 'Unit | Serializer | i-i-s-service-management-customer-ticket-position', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-service-management-customer-ticket-position',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
