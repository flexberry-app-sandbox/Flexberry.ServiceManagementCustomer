...
moduleForModel('i-i-s-service-management-customer-ticket', 'Unit | Serializer | i-i-s-service-management-customer-ticket', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-service-management-customer-ticket',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
