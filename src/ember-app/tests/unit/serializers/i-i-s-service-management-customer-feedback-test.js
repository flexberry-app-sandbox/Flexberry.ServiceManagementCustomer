...
moduleForModel('i-i-s-service-management-customer-feedback', 'Unit | Serializer | i-i-s-service-management-customer-feedback', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-service-management-customer-feedback',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
