...
moduleForModel('i-i-s-service-management-customer-service-provider', 'Unit | Serializer | i-i-s-service-management-customer-service-provider', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-service-management-customer-service-provider',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
