...
moduleForModel('i-i-s-service-management-customer-event', 'Unit | Serializer | i-i-s-service-management-customer-event', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-service-management-customer-event',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
