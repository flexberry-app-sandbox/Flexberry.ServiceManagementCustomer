...
moduleForModel('i-i-s-service-management-customer-customer', 'Unit | Serializer | i-i-s-service-management-customer-customer', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-service-management-customer-customer',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
