...
namespace IIS.Service_Management_Customer
{
    ...
    public class Ticket : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Service_Management_Customer.DetailArrayOfTicketPosition fTicketPosition;
        ...
        public virtual IIS.Service_Management_Customer.DetailArrayOfTicketPosition TicketPosition
        {
            get
            {
                ...
                {
                    this.fTicketPosition = new IIS.Service_Management_Customer.DetailArrayOfTicketPosition(this);
                }
                IIS.Service_Management_Customer.DetailArrayOfTicketPosition result = this.fTicketPosition;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View TicketE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("TicketE", typeof(IIS.Service_Management_Customer.Ticket));
                }
            }
            ...
            public static ICSSoft.STORMNET.View TicketL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("TicketL", typeof(IIS.Service_Management_Customer.Ticket));
                }
            }
        }
    }
