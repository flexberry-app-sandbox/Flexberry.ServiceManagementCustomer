...
namespace IIS.Service_Management_Customer
{
    ...
    public class Event : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Service_Management_Customer.tEventType fEventType;
        ...
        private IIS.Service_Management_Customer.ServiceProvider fServiceProvider;
        ...
        public virtual IIS.Service_Management_Customer.tEventType EventType
        {
            get
            {
                ...
                IIS.Service_Management_Customer.tEventType result = this.fEventType;
        ...
        [NotNull()]
        public virtual IIS.Service_Management_Customer.ServiceProvider ServiceProvider
        {
            get
            {
                ...
                IIS.Service_Management_Customer.ServiceProvider result = this.fServiceProvider;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View EventE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("EventE", typeof(IIS.Service_Management_Customer.Event));
                }
            }
            ...
            public static ICSSoft.STORMNET.View EventL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("EventL", typeof(IIS.Service_Management_Customer.Event));
                }
            }
        }
    }
